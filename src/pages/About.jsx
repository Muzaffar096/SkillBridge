...
const About = () => {
  return (
    <>
      ...
      <div className="flex flex-col p-[30px] xl:p-[60px] bg-white rounded-[10px] mt-[50px] bg-logo xl:flex-row xl:justify-between mb-[50px] xl:mb-[60px]"  data-aos="fade-left">
        <div className="z-10">
          <h2 className="title">
