...
function Benefits() {
    ...
    return (
        <div className="container mx-auto mt-[50px] overflow-hidden">
...
function BenefitCard({
    ...
    return (
        <div>
            <div className="bg-white rounded-[12px] py-[30px] px-[25px] benefit-card" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="1500">
