...
function Testmonial() {
    ...
    const testimonies = [
        {
            ...
            profile: "../../public/testimonials-1.png",
            profileAlt: "profile1",
            profileName: "Sarah L"
        },
        {
            ...
            profile: "../../public/testimonials-2.png",
            profileAlt: "profile2",
            profileName: "Jason M"
        },
        {
            ...
            profile: "../../public/testimonials-3.png",
            profileAlt: "profile3",
            profileName: "Emily R"
        },
        {
            ...
            profile: "../../public/testimonials-4.png",
            profileAlt: "profile4",
    ...
    return (
        <div className=" container mx-auto">
            <div className="flex flex-col lg:flex-row lg:items-center" data-aos="fade-right" data-aos-duration="1200">
                <Title
...
function TestmonialCard({
    ...
    return (
        <div className="bg-[#FFF] rounded-[8px] benefit-card" data-aos="fade-up" data-aos-duration="1200">
